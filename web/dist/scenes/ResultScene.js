...
export class ResultScene extends Scene {
    ...
    render() {
        ...
        r.drawText(`存活时间: ${min}:${sec.toString().padStart(2, '0')}`, cx, cy - 60, { size: 24, color: '#fff', align: 'center' });
        r.drawText(`击杀数: ${this._data.killCount || 0}`, cx, cy - 20, { size: 24, color: '#fff', align: 'center' });
        r.drawText(`获得金币: ${this._data.gold || 0}`, cx, cy + 20, { size: 24, color: '#ffd24a', align: 'center' });
